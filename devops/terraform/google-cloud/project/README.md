    ...
    "projects": [
        {
            ...
            "folder_id": "ID del folder donde se ubicará el proyecto",
            "auto_create_network":"Crea de forma automática la red",
            "billing_account": "Número de la cuenta de cobro que utilizará el proyecto",
            "labels": "Etiquetas que se desean asignar al proyecto en formato llave/valor, ejemplo: {'env':'prod'}"
        },...
    ]
}
```
