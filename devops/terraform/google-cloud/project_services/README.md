# Terraform Project Services

Permite la gestión de una lista de servicios API para un proyecto de Google Cloud Platform.

Para obtener una lista de servicios disponibles, visite la página de la [Biblioteca de APIs](https://console.cloud.google.com/apis/library) o ejecute `gcloud services list --available`.
    ...
    "project_services": [
        {
            ...
            "gcp_service_list": "Lista de Apis que se tienen que habilitar"
        }, ...
    ]
}
```
